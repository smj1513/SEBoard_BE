...
public interface PostSearchJpaRepository extends PostSearchRepository {
    ...
    @Query(value = "select new com.seproject.board.controller.dto.post.PostResponse$RetrievePostListResponseElement(p)" +
    ...
    @Query("select new com.seproject.board.controller.dto.post.PostResponse$RetrievePostDetailResponse(p)" +
    ...
    @Query("select new com.seproject.board.controller.dto.post.PostResponse$RetrievePostListResponseElement(p)" +
