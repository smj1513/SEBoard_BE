...
public class NamedPostController {
    ...
    @PostMapping
    public ResponseMessageDTO createNamedPost(@RequestBody PostDTO.NamedPostRequestDTO dto, Long userId) {
    ...
    @PutMapping("/{postId}")
    public ResponseMessageDTO updateNamedPost(@RequestBody PostDTO.NamedPostRequestDTO dto,
